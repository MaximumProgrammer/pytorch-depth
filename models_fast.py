#
# these are the models from FastDepth, which use the training code from sparse-to-dense:
#
#   - https://github.com/dwofk/fast-depth/blob/master/models.py
#   - https://github.com/dwofk/fast-depth/issues/3#issuecomment-510545490
#
import os
import torch
